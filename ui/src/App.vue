...
let depositJobsSearchDialogVisible=false;
...
<template>
    <Toolbar style="border: 0; border-radius:0; padding: 5px 0 0 0; ">
        <template #start>
            ...
            <div id="toolkit-container-left" class="toolkit-container flex align-items-center gap-2">
                ...
                <Button icon="pi pi-search" label="&nbsp;&nbsp;Search" @click="status.visible = true"/>
    ...
    <DepositJobsSearchDialog v-model:visible="depositJobsSearchDialogVisible"></DepositJobsSearchDialog>
