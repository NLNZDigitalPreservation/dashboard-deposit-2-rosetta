<template>
    <div class="layout-topbar">
        <router-link to="/" class="layout-topbar-logo">
            ...
            <span style="color:red;">Deposit Dashboard</span>
        </router-link>
        ...
        <div class="layout-topbar-menu" :class="topbarMenuClasses">
            ...
            <Button type="button" label="Settings" icon="pi pi-chevron-down" iconPos="right" @click="toggleMenu" text class="mr-2 p-3"/>
        </div>
    </div>
